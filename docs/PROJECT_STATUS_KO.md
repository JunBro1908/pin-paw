...
`src/features/map/components/NaverMap.tsx:470:3`의 `react-hooks/refs` 오류와
`src/app/(tabs)/recommend/page.tsx:24:11`의 미사용 `session` 경고도 남아 있다. 따라서
